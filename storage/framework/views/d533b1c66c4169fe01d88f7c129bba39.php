      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('sale.create')); ?>"><i class="fa fa-pencil"></i> Place An Order</a></li>
            <li><a href="<?php echo e(route('sale.index')); ?>"><i class="fa fa-list"></i> View All Orders</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('purchase.index')); ?>"><i class="fa fa-user"></i> View Purchase List</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('vendor.index')); ?>"><i class="fa fa-user"></i> View Vendors</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo e(route('product.index')); ?>"><i class="fa fa-user"></i> View Products</a></li>
          </ul>
        </li>
