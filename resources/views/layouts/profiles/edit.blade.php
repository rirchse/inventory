    ...
    <div class="col-md-8">
      <div class="card">
          ...
          <div class="card-content">
            ...
            <form action="{{route('my_profile.update', $profile->id)}}" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group label-floating">
                            <label for="first_name" class="control-label">First Name:</label>
                            <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $profile->first_name) }}" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label for="last_name" class="control-label"> Last Name:</label>
                            <input type="text" name="last_name" id="last_name" value="{{ old('last_name', $profile->last_name) }}" class="form-control">
                        </div>
                        <div class="form-group label-floating">
                            <label for="email" class="control-label"> Email Address: </label>
                            <input type="email" name="email" id="email" value="{{ old('email', $profile->email) }}" class="form-control" @disabled ('disabled') >
                        </div>
                    </div>
                    <div class="col-md-6">
