    ...
    <div class="col-md-6"> <!-- general form elements -->
      <div class="box box-primary">
        ...
        <div class="col-md-12 text-right toolbar-icon">
          ...
          <a href="{{route('unit.index')}}" title="View {{Session::get('_types')}} unit" class="label label-success"><i class="fa fa-list"></i></a>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box-body">
          <div class="form-group">
            <label for="unit" class="control-label">Name:</label>
            <input type="text" name="name" id="name" value="{{ old('name', $unit->name) }}" class="form-control" >
          </div>
          <div class="form-group label-floating">
            <label for="symbol" class="control-label">Symbol:</label>
            <input type="text" name="symbol" id="symbol" value="{{ $unit->symbol }}" class="form-control" placeholder="example: packet = pkt">
          </div>
