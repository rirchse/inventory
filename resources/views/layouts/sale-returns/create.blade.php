            ...
            <div class="row">
              <div class="col-xs-6 col-sm-4">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="mobile" id="mobile" onkeyup="getCustomer(this)">
                  </div>
              </div>
              <div class="col-xs-6 col-sm-4">
                  <div class="form-group">
                      <label for="sale_date">Sale Date:</label>
                      <input class="form-control" type="date" name="sale_date" id="sale_date" required onchange="getInvoices(this)">
                  </div>
              </div>
              <div class="col-xs-6 col-sm-4">
                  <div class="form-group">
